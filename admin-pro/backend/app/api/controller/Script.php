...
class Script extends BaseController
{
    ...
    public function list(): Response
    {
        try {
            ...
            return $this->success($scripts);
            
        } catch (\Exception $e) {
            return $this->error('获取脚本列表失败: ' . $e->getMessage());
        }
    }
    ...
    public function get(): Response
    {
        ...
        try {
            ...
            return $this->error('读取脚本失败: ' . $e->getMessage());
        }
    }
    ...
    public function save(): Response
    {
        ...
        try {
            ...
            if (!$syntaxCheck['valid']) {
                return $this->error('Python 语法错误: ' . $syntaxCheck['error']);
            }
            ...
            return $this->error('保存脚本失败: ' . $e->getMessage());
        }
    }
    ...
    public function delete(): Response
    {
        ...
        try {
            ...
            return $this->success(['message' => '脚本删除成功']);
            
        } catch (\Exception $e) {
            return $this->error('删除脚本失败: ' . $e->getMessage());
        }
    }
